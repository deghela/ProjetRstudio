...
-  [R](https://cran.r-project.org/bin/windows/base/): Le script a été écrit pour être exécuté dans l'environnement de programmation R.
- [RStudio](https://rstudio-desktop.en.softonic.com/download?utm_source=bing&utm_medium=paid&utm_campaign=Bing_EN_AU_DSA_Desktop2&msclkid=c8abf3c27d56171e7ca1968e8087f24c): Un environnement de développement intégré (IDE) recommandé pour exécuter le script.
- [ggplot2](https://cran.r-project.org/web/packages/ggplot2/index.html): Une bibliothèque R pour la création de visualisations de données.
- [reshape2](https://www.r-project.org/nosvn/pandoc/reshape2.html) Un package R pour restructurer et agencer les données, utilisé pour préparer les données pour la visualisation.
- [dlypr](https://cran.r-project.org/web/packages/dplyr/index.html): Pour manipuler les données de manière efficace.
## Installation de Packages
 installés les packages: Vous pouvez installer les bibliothèques nécessaires en exécutant les commandes suivantes dans la console R :
```r
